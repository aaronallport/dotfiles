...
You could also use `~/.extra` to override settings, functions and aliases from my dotfiles repository. It’s probably better to [fork Mathias's repository though](https://github.com/mathiasbynens/dotfiles/fork) instead, though.
